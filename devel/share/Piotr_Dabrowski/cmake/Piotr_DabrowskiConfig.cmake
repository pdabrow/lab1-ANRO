...
if(NOT "/home/pdabrow1/catkin_ws/devel/include " STREQUAL " ")
  set(Piotr_Dabrowski_INCLUDE_DIRS "")
  set(_include_dirs "/home/pdabrow1/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Piotr_Dabrowski' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pdabrow1/catkin_ws/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
