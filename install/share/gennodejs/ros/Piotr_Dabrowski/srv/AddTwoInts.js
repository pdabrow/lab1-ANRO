...
// (in-package Piotr_Dabrowski.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'Piotr_Dabrowski/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'Piotr_Dabrowski/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'Piotr_Dabrowski/AddTwoInts'; }
};
